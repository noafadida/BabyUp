...
export const CATEGORIES = [
    ...
    // new Category('c4', 'הטיפים שלנו !', '#FAFAFA',   'https://www.nestlebabyandme.co.il/sites/default/files/styles/content_media_desktop/public/content_image/mrq_vp_m_yrqvt_vtryvt.webp?itok=GLsxSVvl'),
